...
def get_connection() -> duckdb.DuckDBPyConnection:
    ...
    if _connection is None:
        ...
        # Order of query output is fixed by each query's ORDER BY, so we can let
        # DuckDB drop insertion-order preservation. This cuts memory buffering and
        # disk spilling on the heavy join/sort queries (q7/q9/q18/q21), which is the
        # dominant cost at large scale factors.
